...
class TestModule():
    ...
    def test_lstm(self):
        lstm = Tensorflow_LSTM(version="v02", filename="data_19016_lstm_samples_2019-11-10_21:49:27", embed_size=300, max_word_len=50)
        # Reading and splitting dataset
        # Creating, fitting and evaluating model (using custom hyperparameters)
    ...
    def publisher_top_articles_predictions_scenario(self, custom_data={}):
        ...
        def create_predict_sample(df):
            ...
            encoded_titles_X = []
            for title in X:
                encoded_titles_X.append(one_hot(title[0], 70227))
        ...
        # Read model
        model = tf.keras.models.load_model('MachineLearningModels/SavedModels/m.tensorflow_lstm_2019-11-11_v02.h5')
